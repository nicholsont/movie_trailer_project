...
thor_ragnarok = media.Movie("Thor: Ragnarok", "130 min", "PG-13",
...
guardians_of_the_galaxy = media.Movie("Guardians of the Galaxy", "121 min", "PG-13",
